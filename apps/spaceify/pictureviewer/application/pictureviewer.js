...
function PictureViewer()
{
	...
	self.start = fibrous( function()
	{
		try
		{
			...
			rpcSpaceify.sync.connect({hostname: Config.EDGE_HOSTNAME, port: Config.CORE_PORT_WEBSOCKET, persistent: true, owner: "PictureViewer"});
			...
			rpcSpaceify.sync.call("registerService", ["spaceify.org/services/picture_command"], self);
