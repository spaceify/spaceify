...
var language =
	...
	** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** */
	...
	"E_SSOP_START_SPACELET": new SpaceifyError({"code": 2029, "message": "Same Origin Policy rules prevent starting the spacelet."}),

	"E_FAILED_TO_SAVE_SETTINGS": new SpaceifyError({"code": 2030, "message": "Failed to save settings."}),
	"E_SETTINGS_PROPERTY": new SpaceifyError({"code": 2031, "message": "Property ~property is missing."}),
	"E_SETTINGS_DATATYPE": new SpaceifyError({"code": 2032, "message": "Datatype of property ~property must be ~datatype."}),

	// Common
	"E_JSON_PARSE_FAILED": new SpaceifyError({"code": 3003, "message": "Failed to parse JSON."}),

	// DockerContainer
	"E_CREATE_CONTAINER_FAILED": new SpaceifyError({"code": 4000, "message": "Creating the docker container failed."}),
	"E_INIT_CONTAINER_FAILED": new SpaceifyError({"code": 4001, "message": "Initializing the docker container failed."}),
	"E_START_CONTAINER_FAILED": new SpaceifyError({"code": 4002, "message": "Starting the docker container failed."}),
	"E_CONTAINER_INSPECT_FAILED": new SpaceifyError({"code": 4003, "message": "Inspecting the docker container failed."}),
	...
	// DockerHelper
	"E_ATTACH_CONTAINER_FAILED": new SpaceifyError({"code": 6000, "message": "Attaching docker container failed."}),
	...
	// WebOperation
	"E_NO_OPERATION_DEFINED": "{\"code\": 15000, \"message\": \"No operation defined.\", \"path\": \"WebOperation::getData()\"}",
	"E_UNDEFINED_OPERATION_DEFINED": "{\"code\": 15001, \"message\": \"Undefined operation requested.\", \"path\": \"WebOperation::getData()\"}",
	"E_UNDEFINED_PARAMETERS": "{\"code\": 15002, \"message\": \"Required parameter(s) undefined.\", \"path\": \"WebOperation::getData()\"}",
	"E_INVALID_DATA_POST": "{\"code\": 15003, \"message\": \"The submitted data is invalid.\", \"path\": \"WebOperation::getData()\"}",
	...
	"E_ADMIN_LOGIN_USER": new SpaceifyError({"code": 16004, "message": "Failed to get user data."}),
	"E_ADMIN_LOGIN_PASSWORD": new SpaceifyError({"code": 16005, "message": "The password is incorrect."}),
	"E_NON_EDGE_CALLER": new SpaceifyError({"code": 16006, "message": "Calls outside of the Spaceify edge are forbidden."}),
