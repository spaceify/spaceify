...
function lease_store(start, end)
	{
	this.start = start;
	this.end = end;
	return this;
...
lease_store.prototype.remove_lease = function remove_lease(mac_addr, cb)
	{ // ToDo: this should probably be made to be a lot more careful
...
lease_store.prototype.get_lease = function get_lease(mac_addr, cb)
	{
	var lease;
	if(leases[mac_addr])												// ensure we return a new copy!!
