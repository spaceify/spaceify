...
var fromBuffer = function(b)
	...
	ret = {
		...
		serverhostname: stripBinNull(b.toString('ascii', 44, 108)),
		bootfilename: stripBinNull(b.toString('ascii', 108, 236)),
		options: {}
		};
...
var toBuffer = function()
	...
	if(this.serverhostname)
		buffer.write(this.serverhostname, 43, 64, 'ascii');
	if(this.bootfilename)
		buffer.write(this.bootfilename, 109, 128, 'ascii');
...
Packet.prototype.serverhostname = function(serverhostname)
	{
	this.serverhostname = serverhostname;
	return this;
	};

Packet.prototype.bootfilename = function(bootfilename)
	{
