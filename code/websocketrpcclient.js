...
self.call = function(methods, params, object, listener)
	{
	if(connection == null && typeof listener == "function")
...
var onMessage = function(message)
	{
	logger.info(Utility.replace(Language.WEBSOCKET_ON_MESSAGE, {":owner": options.owner, ":class": options.class, ":protocol": options.protocol, ":hostname": options.hostname, ":port": options.port, ":subprotocol": "json-rpc", ":id": "-", ":message": message.utf8Data}));
