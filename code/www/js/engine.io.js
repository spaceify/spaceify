...
function Socket(uri, opts){
  ...
  // START - REQUIRED BY SPACEIFY
  this.spaceify_subprotocol = opts.spaceify_subprotocol;
  // END - REQUIRED BY SPACEIFY  
...
Socket.prototype.open = function () {
  ...
  try {
    ...
    // START - REQUIRED BY SPACEIFY
    transport.spaceify_subprotocol = this.spaceify_subprotocol;
    // END - REQUIRED BY SPACEIFY
  } catch (e) {
...
WS.prototype.doOpen = function(){
  ...
  var protocols = this.spaceify_subprotocol;
  // END - REQUIRED BY SPACEIFY
