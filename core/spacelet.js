...
self.getInstallationPath = function()
	{
	return Config.SPACELETS_PATH + manifest.unique_directory + Config.VOLUME_DIRECTORY + Config.APPLICATION_DIRECTORY;
	}
...
// spacelet returns its status: true = successfully initialized itself, false = failed to initialize itself
...
// Unique identifier in stored spacelets (SpaceletManager::spacelets, SpaceletManager::ordinal)
...
module.exports = Spacelet;                                // Export class not object so that multiple instances can be created
