...
(function() {
    ...
    */
    ...
    {
		if(this.data && this.data.smarty && this.data.smarty.config && this.data.smarty.config[name])
			return this.data.smarty.config[name];

        return "";	//throw new Error('No config for ' + name);
    }
